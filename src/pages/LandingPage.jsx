...
import { 
  ...
  Zap, ChevronRight, Eye, Target, Search, Globe, Activity, Mail
} from 'lucide-react';
  ...
  return (
    <div className="landing-page" style={{ background: '#020617', color: 'white', minHeight: '100vh', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <footer style={{ padding: '60px 20px', borderTop: '1px solid var(--border)', textAlign: 'center', color: 'var(--text-muted)' }}>
        ...
        <div style={{ marginTop: '15px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '25px', fontSize: '0.95rem', opacity: 0.8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <Mail size={18} style={{ color: '#00a8ff' }} />
            <span>info@centinela-security.com</span>
          </div>
          <a 
            href="https://wa.me/5491125298774" 
            target="_blank" 
            rel="noopener noreferrer" 
            style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'inherit', textDecoration: 'none', transition: '0.3s' }}
          ...
          >
            ...
            <span style={{ fontWeight: 'bold' }}>+54 9 11 2529-8774</span>
          </a>
        </div>
      </footer>
