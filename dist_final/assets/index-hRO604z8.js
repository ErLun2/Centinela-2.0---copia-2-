const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LandingPage-O5gc9Kpd.js","assets/dbServices-BahM73c-.js","assets/map-pin-El6IADwm.js","assets/qr-code-Ke2hCGDu.js","assets/globe-Dw7yTO4P.js","assets/search-DjuSWJPc.js","assets/zap-Cwvco1aw.js","assets/LoginPage-BfzMDIxS.js","assets/user-BT88PJep.js","assets/building-2-QiFASoH3.js","assets/eye-off-DjT2m7FS.js","assets/eye-CvIjxdgM.js","assets/circle-help-DM6-EhDf.js","assets/ResetPassword-Cm1dcP5b.js","assets/MasterDashboard-DHzqp7cz.js","assets/planes-BFbnCcra.js","assets/TileLayer-880WwhPR.js","assets/users-C_cvIcTt.js","assets/log-out-IpbFHbyo.js","assets/wifi-D4mdMzV5.js","assets/MasterDashboard-CIGW-MKW.css","assets/SupportDashboard-CeZY7Eu0.js","assets/pen-line-BRDp6GFU.js","assets/clock-mKeDkRrR.js","assets/CompanyDashboard-D6R50Dlf.js","assets/play-CxGsulzm.js","assets/StaffApp-BK7tJpVD.js"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qo=XC;function rA(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r={name:Mh,automaticDataCollectionEnabled:!0,...e},i=r.name;if(typeof i!="string"||!i)throw sr.create("bad-app-name",{appName:String(i)});if(n||(n=IE()),!n)throw sr.create("no-options");const s=xl.get(i);if(s){if(Jr(n,s.options)&&Jr(r,s.config))return s;throw sr.create("duplicate-app",{appName:i})}const o=new uC(i);for(const u of Uh.values())o.addComponent(u);const l=new nA(n,r,o);return xl.set(i,l),l}function iA(t=Mh){const e=xl.get(t);if(!e&&t===Mh&&IE())return rA();if(!e)throw sr.create("no-app",{appName:t});return e}function xi(t,e,n){let r=ZC[t]??t;n&&(r+=`-${n}`);const i=r.match(/\s|\//),s=e.match(/\s|\//);if(i||s){const o=[`Unable to register library "${r}" with version "${e}":`];i&&o.push(`library name "${r}" contains illegal characters (whitespace or "/")`),i&&s&&o.push("and"),s&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Tn.warn(o.join(" "));return}No(new Yr(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jo{constructor(e,n){this.shortDelay=e,this.longDelay=n,In(n>e,"Short delay should be less than long delay!"),this.isMobile=HS()||KS()}get(){return _A()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ig=new Map;function mn(t){In(t instanceof Function,"Expected a class definition");let e=Ig.get(t);return e?(In(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,Ig.set(t,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const LR="pendingRedirect",el=new Map;class MR extends hw{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=el.get(this.auth._key());if(!e){try{const r=await UR(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}el.set(this.auth._key(),e)}return this.bypassAuthState||el.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function UR(t,e){const n=zR(e),r=BR(t);if(!await r._isAvailable())return!1;const i=await r._get(n)==="true";return await r._remove(n),i}function FR(t,e){el.set(t._key(),e)}function BR(t){return mn(t._redirectPersistence)}function zR(t){return Za(LR,t.config.apiKey,t.name)}async function $R(t,e,n=!1){if(Xt(t.app))return Promise.reject(or(t));const r=os(t),i=DR(r,e),o=await new MR(r,i,n).execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
